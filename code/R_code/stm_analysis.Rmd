...
#2. format model:
labelTopics(model_format, c(3,7,20))
...
labelTopics(model_year, c(3,7,20))
labelTopics(model_year, n=5)
plot(model_year, type = "summary") #plot the estimated topic porportions

cloud(model_year) #wordclound for all topics
cloud(model_year, topic = 23) #wordcloud for specific topic
...
labelTopics(model_ages, c(3,7,20))
labelTopics(model_ages, n=5)
plot(model_ages, type = "summary") #plot the estimated topic porportions

cloud(model_ages) #wordclound for all topics
cloud(model_ages, topic = 16) #wordcloud for specific topic
...
labelTopics(model_before, c(3,7,20))
labelTopics(model_before, n=5)
plot(model_before, type = "summary") #plot the estimated topic porportions

cloud(model_before) #wordclound for all topics
cloud(model_before, topic = 16) #wordcloud for specific topic
