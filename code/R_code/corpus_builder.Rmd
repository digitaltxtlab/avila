...
###Import data  
Imports all the datafiles from the data_plain folder into a "Versatile Corpus"  
```{r}

books.cor  <- VCorpus(DirSource(paste(wd,"/data/plain_data", sep=''), encoding = "UTF-8"), readerControl = list(language = "lat")) #import all texts in the plain data folder to a corpus

```

###Add metadata
Adds all the metadata from the metadata csv to the Versatile Corpus created abov  
