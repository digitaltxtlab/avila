...
In the cleaning process, all footnotes are removed from the corpus
The corpus is then saved as an RData file, which can also be found in the "data" folder
...
clean_corpus <- function(corpus){
  ...
  tm_map(removeWords, stop.words) %>% #alternatively, use: stopwords("english")
...
#exporter dtm som csv
write.csv(as.matrix(dtm), file = "data/dtm_clean_corpus.csv")
